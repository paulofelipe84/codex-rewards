        ...
        <div class="container">
          ...
          <div class="row cvh position-relative">
            <div class="col-md-6 align-self-center my-md-0 mt-4">
              ...
              <div class="mt-5">
                <button class="btn cbtn bg-prime shadow-sm me-md-3">Start Staking</button>
                <button class="btn cbtn btn-dark shadow-sm ms-md-5 ms-3">Learn More</button>
              </div>
            </div>
    ...
    methods: {
      async getStats () {
        ...
        try {
          ...
          let yearlyReward = decodedResult[0] / 1e8 * 31536000 // 1 Year in seconds
          ...
          self.yearlyYield = yearlyReward / self.amountStaked * 100
